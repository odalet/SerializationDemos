...
public interface Api {
    ...
    public SearchCitiesResponse searchCities(
        @WebParam(partName = "parameters", name = "searchCitiesRequest", targetNamespace = "http://www.delta.io/Api/")
        SearchCitiesRequest parameters
    );
}
